...
const handleSubCategoryClick = (categoryName, subCategory) => {
  categorySubCategories.value[categoryName] = subCategory
}
        ...
        >
          ...
          >
            <a 
              ...
              :href="'#' + category.name"
              class="submenu-item"
              :class="{ 'active': categorySubCategories.value[category.name] === item }"
    ...
    <main class="main-content">
      ...
      <section id="最新推荐" class="category-section">
        ...
        <div class="tools-grid hot-recommendations">
          <ToolCard
            v-for="tool in tools.filter(t => t.category === '最新推荐')"
            :key="tool.title"
            :title="tool.title"
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.value['AI绘画'] === tag }"
        ...
        <div class="tools-grid">
          <ToolCard
            v-for="tool in tools.filter(t => {
              if (t.category !== 'AI绘画') return false;
              if (categorySubCategories.value['AI绘画'] === '热门推荐') {
                return t.tags.some(tag => tag.type === 'hot');
              }
              return t.subCategory === categorySubCategories.value['AI绘画'];
            })"
            :key="tool.title"
            :title="tool.title"
            :description="tool.description"
      ...
      <section id="AI写作" class="category-section">
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.value['AI写作'] === tag }"
        ...
        <div class="tools-grid">
          <ToolCard
            v-for="tool in tools.filter(t => {
              if (t.category !== 'AI写作') return false;
              if (categorySubCategories.value['AI写作'] === '热门推荐') {
                return t.tags.some(tag => tag.type === 'hot');
              }
              return t.subCategory === categorySubCategories.value['AI写作'];
            })"
            :key="tool.title"
            :title="tool.title"
            :description="tool.description"
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags" v-if="category.hasSubmenu">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.value[category.name] === tag }"
        ...
        <div class="tools-grid">
          <ToolCard
            v-for="tool in tools.filter(t => {
              ...
              if (categorySubCategories.value[category.name] === '热门推荐') {
                return t.tags.some(tag => tag.type === 'hot');
              }
              return t.subCategory === categorySubCategories.value[category.name];
            })"
            :key="tool.title"
            :title="tool.title"
            :description="tool.description"
