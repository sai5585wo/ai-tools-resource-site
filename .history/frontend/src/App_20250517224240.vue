...
const categories = [
  ...
  { 
    ...
    icon: '💡',
    hasSubmenu: true,
    submenu: ['绘画提示词', '写作提示词', '视频提示词']
  },
  { 
    name: 'AI设计', 
    icon: '🎯',
    hasSubmenu: true,
    submenu: ['UI设计', 'Logo设计', '海报设计', '品牌设计']
  },
  { 
    name: 'AI数字人', 
    icon: '👤',
    hasSubmenu: true,
    submenu: ['数字人生成', '数字人定制', '数字人直播']
  },
  { 
    name: 'AI插件', 
    icon: '🔌',
    hasSubmenu: true,
    submenu: ['浏览器插件', '设计插件', '办公插件']
  }
]
...
const filteredTools = computed(() => {
  return tools.filter(tool => {
    ...
    if (category?.hasSubmenu && currentSubCategory.value !== '热门推荐') {
