...
const tools = [
  ...
  // AI视频
  {
    ...
    icon: 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f3ac.png',
    category: 'AI视频',
  ...
  },
  {
    ...
    tags: [{ text: '免费', type: 'free' }, { text: 'EN', type: 'en' }],
    icon: 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/2328.png',
    category: 'AI编程',
  ...
  },
  {
    ...
    tags: [{ text: '推荐', type: 'hot' }, { text: 'EN', type: 'en' }],
    icon: 'https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f5b1.png',
    category: 'AI编程',
    url: 'https://cursor.sh'
  }
]
