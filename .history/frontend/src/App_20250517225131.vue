...
// 使用 Map 为每个分类维护独立的子分类状态
const categorySubCategories = ref(new Map(categories.map(category => [category.name, '热门推荐'])))
...
const filteredTools = computed(() => {
  return tools.filter(tool => {
    ...
    if (category?.hasSubmenu) {
      const currentSubCategory = categorySubCategories.value.get(currentCategory.value)
        ...
        >
          ...
          >
            <a 
              ...
              :href="'#' + category.name"
              class="submenu-item"
              :class="{ 'active': categorySubCategories.get(category.name) === item }"
              @click.prevent="categorySubCategories.set(category.name, item)"
            >
              {{ item }}
            </a>
          </div>
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.get('AI绘画') === tag }"
                @click.prevent="categorySubCategories.set('AI绘画', tag)"
              >
                {{ tag }}
              </a>
            </div>
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.get('AI写作') === tag }"
                @click.prevent="categorySubCategories.set('AI写作', tag)"
              >
                {{ tag }}
              </a>
            </div>
          ...
          <div class="header-wrapper">
            ...
            <div class="category-tags" v-if="category.hasSubmenu">
              <a href="#" 
                ...
                :key="tag"
                :class="{ 'active': categorySubCategories.get(category.name) === tag }"
                @click.prevent="categorySubCategories.set(category.name, tag)"
              >
                {{ tag }}
              </a>
            </div>
