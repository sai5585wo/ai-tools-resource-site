...
const tools = [
  ...
  {
    title: '可灵AI',
    description: '专业的AI数字人视频生成平台，支持多语言配音。',
    tags: [{ text: '热门', type: 'hot' }, { text: '中文', type: 'zh' }],
    icon: '🎭',
    category: 'AI视频',
    subCategory: '热门推荐',
    url: 'https://www.xcloudai.com'
  },
  {
    title: '即梦',
    description: '强大的AI视频创作平台，支持一键生成营销视频。',
    tags: [{ text: '推荐', type: 'hot' }, { text: '中文', type: 'zh' }],
    icon: '✨',
    category: 'AI视频',
    subCategory: '热门推荐',
  ...
  {
    title: 'WonderStudio',
    description: '专业的AI视频制作工具，支持场景定制。',
    tags: [{ text: '新品', type: 'new' }, { text: '中文', type: 'zh' }],
    icon: '🎬',
    category: 'AI视频',
    subCategory: 'AI自动剪辑',
    url: 'https://wonderstudio.ai'
  },
  {
    title: 'Fliki',
    description: '将文本转换为专业视频的AI工具。',
    tags: [{ text: '付费', type: 'pro' }, { text: 'EN', type: 'en' }],
    icon: '🎥',
    category: 'AI视频',
    subCategory: 'AI自动剪辑',
  ...
  {
    title: 'Runway Gen-2',
    description: '新一代AI视频生成工具，支持文本生成视频。',
    tags: [{ text: '新品', type: 'new' }, { text: 'EN', type: 'en' }],
    icon: '🚀',
    category: 'AI视频',
    subCategory: '热门推荐',
  ...
  {
    title: 'Descript',
    description: '创新的AI视频编辑工具，支持文本编辑视频。',
    tags: [{ text: '推荐', type: 'hot' }, { text: 'EN', type: 'en' }],
    icon: '📝',
    category: 'AI视频',
    subCategory: 'AI自动剪辑',
  ...
  {
    title: 'Veed.io',
    description: '专业的在线视频编辑平台，支持AI功能。',
    tags: [{ text: '热门', type: 'hot' }, { text: 'EN', type: 'en' }],
    icon: '🎥',
    category: 'AI视频',
    subCategory: 'AI自动剪辑',
  ...
  {
    title: '讯飞智文',
    description: '科大讯飞出品的智能文档工具，支持语音转写和文档处理。',
    tags: [{ text: '推荐', type: 'hot' }, { text: '中文', type: 'zh' }],
    icon: '📄',
    category: 'AI办公',
    subCategory: 'AI文档助手',
    url: 'https://iwrite.xfyun.cn'
  },
  {
    title: '飞书文档',
    description: '字节跳动出品的智能办公套件，集成AI助手。',
    tags: [{ text: '热门', type: 'hot' }, { text: '中文', type: 'zh' }],
    icon: '📝',
    category: 'AI办公',
    subCategory: 'AI文档助手',
  ...
  {
    title: 'WPS AI',
    description: '金山办公推出的AI办公助手，提供智能文档处理。',
    tags: [{ text: '免费', type: 'free' }, { text: '中文', type: 'zh' }],
    icon: '💼',
    category: 'AI办公',
    subCategory: '热门推荐',
  ...
  {
    title: '腾讯文档',
    description: '腾讯推出的在线协作工具，集成AI功能。',
    tags: [{ text: '免费', type: 'free' }, { text: '中文', type: 'zh' }],
    icon: '📊',
    category: 'AI办公',
    subCategory: 'AI文档助手',
  ...
  {
    title: 'Notion AI',
    description: '强大的笔记和知识管理工具，集成AI助手。',
    tags: [{ text: '付费', type: 'pro' }, { text: '中英', type: 'zh' }],
    icon: '📚',
    category: 'AI办公',
    subCategory: '热门推荐',
  ...
  {
    title: '讯飞星火',
    description: '科大讯飞推出的认知大模型，擅长中文理解和专业领域。',
    tags: [{ text: '热门', type: 'hot' }, { text: '中文', type: 'zh' }],
    icon: '🌟',
    category: 'AI聊天',
    subCategory: '热门推荐',
  ...
  {
    title: '百川大模型',
    description: '百度推出的大规模语言模型，支持多场景应用。',
    tags: [{ text: '新品', type: 'new' }, { text: '中文', type: 'zh' }],
    icon: '🌊',
    category: 'AI聊天',
    subCategory: '热门推荐',
  ...
  {
    title: '智谱AI',
    description: '清华大学推出的AI大模型，擅长学术和专业对话。',
    tags: [{ text: '专业', type: 'pro' }, { text: '中文', type: 'zh' }],
    icon: '🎓',
    category: 'AI聊天',
    subCategory: '热门推荐',
  ...
  {
    title: '腾讯智影',
    description: '腾讯推出的AI创意工具，支持图片和视频生成。',
    tags: [{ text: '免费', type: 'free' }, { text: '中文', type: 'zh' }],
    icon: '🎨',
    category: 'AI绘画',
    subCategory: '热门推荐',
  ...
  },
  {
    ...
    description: '开源AI绘画模型的增强版本，效果更优。',
    tags: [{ text: '新品', type: 'new' }, { text: 'EN', type: 'en' }],
    icon: '🎨',
    category: 'AI绘画',
    subCategory: '热门推荐',
