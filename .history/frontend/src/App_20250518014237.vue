...
const tools = [
  ...
  {
    title: 'Fireflies.ai',
    description: 'AI会议助手和笔记工具。',
    tags: [{ text: '会议', type: 'meeting' }, { text: 'EN', type: 'en' }],
    icon: '✨',
    category: 'AI办公',
    subCategory: 'AI文档助手',
  ...
  {
    title: 'Miro AI',
    description: 'AI驱动的在线协作白板。',
    tags: [{ text: '协作', type: 'collaboration' }, { text: 'EN', type: 'en' }],
    icon: '🎯',
    category: 'AI办公',
    subCategory: 'AI思维导图',
  ...
  {
    title: 'Craft AI',
    description: 'AI文档和知识管理工具。',
    tags: [{ text: '知识管理', type: 'km' }, { text: 'EN', type: 'en' }],
    icon: '📚',
    category: 'AI办公',
    subCategory: 'AI文档助手',
    url: 'https://www.craft.do'
  },
  {
    ...
    tags: [{ text: '演示', type: 'presentation' }, { text: 'EN', type: 'en' }],
    icon: '🎭',
    category: 'AI办公',
    subCategory: 'AI制作PPT',
    url: 'https://pitch.com'
  ...
  {
    title: 'Smartsheet AI',
    description: 'AI项目管理平台。',
    tags: [{ text: '项目管理', type: 'pm' }, { text: 'EN', type: 'en' }],
    icon: '📋',
    category: 'AI办公',
    subCategory: 'AI表格处理',
  ...
  {
    title: 'Replika',
    description: 'AI情感陪伴机器人。',
    tags: [{ text: '陪伴', type: 'companion' }, { text: 'EN', type: 'en' }],
    icon: '🤖',
    category: 'AI聊天',
    subCategory: 'AI虚拟角色',
    url: 'https://replika.com'
  ...
  {
    title: 'Jasper Chat',
    description: 'AI营销内容助手。',
    tags: [{ text: '营销', type: 'marketing' }, { text: 'EN', type: 'en' }],
    icon: '💬',
    category: 'AI聊天',
    subCategory: 'AI智能客服',
    url: 'https://jasper.ai/chat'
  },
  {
    title: 'YouChat',
    description: 'AI搜索对话引擎。',
  ...
  {
    title: 'DeepInfra',
    description: 'AI模型部署和对话平台。',
    tags: [{ text: '技术', type: 'tech' }, { text: 'EN', type: 'en' }],
    icon: '⚡',
    category: 'AI聊天',
    subCategory: 'AI智能客服',
