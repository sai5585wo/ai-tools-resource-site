...
const tools = [
  ...
  },
  {
    title: 'Soundraw',
    description: 'AI音乐创作平台。',
    tags: [{ text: '音乐', type: 'music' }, { text: 'EN', type: 'en' }],
    icon: '🎼',
    category: 'AI音频',
    subCategory: 'AI配乐',
    url: 'https://soundraw.io'
  },
  {
    title: 'Voicemod',
    description: 'AI变声器。',
    tags: [{ text: '娱乐', type: 'entertainment' }, { text: 'EN', type: 'en' }],
    icon: '🎭',
    category: 'AI音频',
    subCategory: 'AI变声',
    url: 'https://www.voicemod.net'
  ...
  },
  {
    title: 'Voice AI',
    description: '实时AI变声器。',
    tags: [{ text: '实时', type: 'realtime' }, { text: 'EN', type: 'en' }],
    icon: '🎤',
    category: 'AI音频',
    subCategory: 'AI变声',
    url: 'https://voice.ai'
  },
  {
    ...
    tags: [{ text: '播客', type: 'podcast' }, { text: 'EN', type: 'en' }],
    icon: '🎙️',
    category: 'AI音频',
    subCategory: '语音转文本',
  ...
  // AI提示词新增工具
  {
    title: 'PromptBase',
    description: 'AI提示词市场。',
    tags: [{ text: '市场', type: 'marketplace' }, { text: 'EN', type: 'en' }],
    icon: '💡',
    category: 'AI提示词',
    subCategory: '提示词市场',
    url: 'https://promptbase.com'
  },
  {
    ...
    description: 'MJ提示词助手。',
    tags: [{ text: '辅助', type: 'helper' }, { text: 'EN', type: 'en' }],
    icon: '🎨',
    category: 'AI提示词',
    subCategory: '提示词生成',
  ...
  },
  {
    ...
    tags: [{ text: '生成', type: 'generator' }, { text: 'EN', type: 'en' }],
    icon: '✨',
    category: 'AI提示词',
    subCategory: '提示词生成',
  ...
  {
    title: 'PromptHero',
    description: 'AI艺术提示词社区。',
    tags: [{ text: '社区', type: 'community' }, { text: 'EN', type: 'en' }],
    icon: '🦸',
    category: 'AI提示词',
    subCategory: '提示词市场',
    url: 'https://prompthero.com'
  ...
  },
  {
    ...
    description: '提示词学习平台。',
    tags: [{ text: '学习', type: 'learning' }, { text: 'EN', type: 'en' }],
    icon: '🎓',
    category: 'AI提示词',
    subCategory: '提示词教程',
    url: 'https://learnprompting.org'
  },
  {
    ...
    description: '提示词工程资源。',
    tags: [{ text: '资源', type: 'resource' }, { text: 'EN', type: 'en' }],
    icon: '🔧',
    category: 'AI提示词',
    subCategory: '提示词教程',
  ...
  },
  {
    ...
    description: 'SD提示词指南。',
    tags: [{ text: '指南', type: 'guide' }, { text: 'EN', type: 'en' }],
    icon: '🎨',
    category: 'AI提示词',
    subCategory: '提示词教程',
  ...
  {
    title: 'FlowGPT',
    description: 'ChatGPT提示词分享平台。',
    tags: [{ text: '分享', type: 'share' }, { text: 'EN', type: 'en' }],
    icon: '🌊',
    category: 'AI提示词',
    subCategory: '提示词市场',
  ...
  },
  {
    title: 'Promptist',
    description: 'AI提示词优化工具。',
    tags: [{ text: '优化', type: 'optimization' }, { text: 'EN', type: 'en' }],
    icon: '🎯',
    category: 'AI提示词',
    subCategory: '提示词生成',
    url: 'https://promptist.com'
  ...
  },
  {
    title: 'Framer AI',
    description: 'AI网站生成器。',
    tags: [{ text: '网站', type: 'website' }, { text: 'EN', type: 'en' }],
    icon: '🌐',
    category: 'AI设计',
    subCategory: 'UI设计',
  ...
  {
    title: 'Uizard',
    description: 'AI UI设计工具。',
    tags: [{ text: 'UI', type: 'ui' }, { text: 'EN', type: 'en' }],
    icon: '🎯',
    category: 'AI设计',
    subCategory: 'UI设计',
    url: 'https://uizard.io'
  ...
  {
    title: 'Vizcom',
    description: 'AI产品设计工具。',
    tags: [{ text: '产品', type: 'product' }, { text: 'EN', type: 'en' }],
    icon: '📱',
    category: 'AI设计',
    subCategory: '产品设计',
  ...
  {
    title: 'Interior AI',
    description: 'AI室内设计工具。',
    tags: [{ text: '室内', type: 'interior' }, { text: 'EN', type: 'en' }],
    icon: '🏠',
    category: 'AI设计',
    subCategory: '室内设计',
  ...
  {
    title: 'Booth AI',
    description: 'AI产品摄影工具。',
    tags: [{ text: '摄影', type: 'photo' }, { text: 'EN', type: 'en' }],
    icon: '📸',
    category: 'AI设计',
    subCategory: '产品设计',
    url: 'https://booth.ai'
  },
  {
    title: 'Dimensions',
    description: 'AI Logo设计工具。',
    tags: [{ text: 'Logo', type: 'logo' }, { text: 'EN', type: 'en' }],
    icon: '🎨',
    category: 'AI设计',
    subCategory: 'Logo设计',
  ...
  // AI数字人新增工具
  {
    title: 'D-ID',
    description: 'AI数字人视频生成平台。',
    tags: [{ text: '视频', type: 'video' }, { text: 'EN', type: 'en' }],
    icon: '🎥',
    category: 'AI数字人',
    subCategory: '数字人生成',
    url: 'https://www.d-id.com'
  ...
  {
    title: 'Hour One',
    description: 'AI数字人视频制作。',
    tags: [{ text: '商业', type: 'business' }, { text: 'EN', type: 'en' }],
    icon: '👤',
    category: 'AI数字人',
    subCategory: '数字人生成',
    url: 'https://hourone.ai'
  ...
  {
    title: 'DeepBrain AI',
    description: 'AI数字人解决方案。',
    tags: [{ text: '企业', type: 'enterprise' }, { text: 'EN', type: 'en' }],
    icon: '🧠',
    category: 'AI数字人',
    subCategory: '数字人定制',
    url: 'https://www.deepbrainai.io'
  },
  {
    title: 'Colossyan',
    description: 'AI数字人培训视频。',
    tags: [{ text: '教育', type: 'education' }, { text: 'EN', type: 'en' }],
    icon: '👨‍🏫',
    category: 'AI数字人',
    subCategory: '数字人生成',
    url: 'https://www.colossyan.com'
  ...
  {
    title: 'Descript',
    description: 'AI数字人配音工具。',
    tags: [{ text: '配音', type: 'voice' }, { text: 'EN', type: 'en' }],
    icon: '🎙️',
    category: 'AI数字人',
    subCategory: '数字人配音',
    url: 'https://www.descript.com'
  ...
  {
    title: 'ChatGPT for Google',
    description: '谷歌搜索ChatGPT插件。',
    tags: [{ text: '搜索', type: 'search' }, { text: 'EN', type: 'en' }],
    icon: '🔍',
    category: 'AI插件',
    subCategory: '浏览器插件',
    url: 'https://chrome.google.com/webstore/detail/chatgpt-for-google/jgjaeacdkonaoafenlfkkkmbaopkbilf'
  ...
  {
    title: 'Grammarly AI',
    description: 'AI写作校对插件。',
    tags: [{ text: '校对', type: 'proofreading' }, { text: 'EN', type: 'en' }],
    icon: '✅',
    category: 'AI插件',
    subCategory: '写作插件',
    url: 'https://www.grammarly.com'
  ...
  {
    title: 'Compose AI',
    description: 'AI邮件写作插件。',
    tags: [{ text: '邮件', type: 'email' }, { text: 'EN', type: 'en' }],
    icon: '⌨️',
    category: 'AI编程',
    subCategory: '代码补全',
    url: 'https://www.tabnine.com'
  },
  {
    title: 'Kite',
    description: 'AI编程助手。',
    tags: [{ text: '开源', type: 'opensource' }, { text: 'EN', type: 'en' }],
    icon: '🪁',
    category: 'AI编程',
    subCategory: '代码补全',
  ...
  {
    title: 'Replit AI',
    description: '在线IDE的AI助手。',
    tags: [{ text: '云端', type: 'cloud' }, { text: 'EN', type: 'en' }],
    icon: '💻',
    category: 'AI编程',
    subCategory: '代码生成',
  ...
  },
  {
    ...
    tags: [{ text: '开源', type: 'opensource' }, { text: '中英', type: 'zh' }],
    icon: '🔧',
    category: 'AI编程',
    subCategory: '代码生成',
    url: 'https://codegeex.cn'
  ...
  {
    title: 'CodeConverter',
    description: 'AI代码转换工具。',
    tags: [{ text: '转换', type: 'conversion' }, { text: 'EN', type: 'en' }],
    icon: '🔄',
    category: 'AI编程',
    subCategory: '代码转换',
    url: 'https://codeconverter.ai'
  },
  {
    ...
    tags: [{ text: '安全', type: 'security' }, { text: 'EN', type: 'en' }],
    icon: '🛡️',
    category: 'AI编程',
    subCategory: '代码优化',
    url: 'https://safurai.com'
  ...
  {
    title: 'Anthropic Claude 3',
    description: '最新一代AI语言模型，支持多模态理解。',
    tags: [{ text: '新品', type: 'new' }, { text: 'EN', type: 'en' }],
    icon: '🤖',
    category: '最新推荐',
    subCategory: '最新推荐',
  ...
  {
    title: 'Stable Video 3',
    description: 'Stability AI最新视频生成模型。',
    tags: [{ text: '新品', type: 'new' }, { text: 'EN', type: 'en' }],
    icon: '🎬',
    category: '最新推荐',
    subCategory: '最新推荐',
  ...
  {
    title: '秘塔写作',
    description: '专业的中文写作助手。',
    tags: [{ text: '付费', type: 'pro' }, { text: '中文', type: 'zh' }],
    icon: '✨',
    category: 'AI写作',
    subCategory: '热门推荐',
    url: 'https://xiezuo.metaso.cn'
...
const filteredTools = computed(() => {
  ...
  return tools.filter(tool => {
    ...
    return searchTerms.every(term => 
      // 标题中的单词匹配
      title.split(/\s+/).some(word => word.includes(term)) ||
      // 描述中的单词匹配
      description.split(/\s+/).some(word => word.includes(term))
    )
  })
})
